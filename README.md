...
The predicted implant shape (or the completed skull) can be evaluated quantitatively using Dice Similarity Score or Hausdorff Distance, or qualitatively by assessing how it matches with the ground truth. However, better and more specialized quantitative metrics can be devised for more accurate evaluation of how two shapes match each other.
